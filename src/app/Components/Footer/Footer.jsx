        ...
        <main className="w-full h-full max-w-[1600px] mx-auto  p-4  lg:p-[3rem]  tracking-wide  max-lg:pb-26  font-light">
          <div
            className="content border-b pb-4  border-dotted border-white/50 text-white/90
              grid grid-cols-2 md:grid-cols-3 lg:grid-cols-[300px_150px_180px_300px]  justify-between  space-y-5  lg:items-start "
          >
            {/* Insurance */}
            ...
            <div className="lg:pt-0 shrink-0  min-w-[250px] lg:mb-6  ">
              ...
              <div className="flex flex-col text-[14px] flex-wrap space-y-4">
                <div className="flex items-start gap-1">
                  ...
                  <a href="tel:9592000818" className="text-white/90 hover:text-white transition-colors">
                 95920 00818
                  </a>
                </div>
                <div className="flex items-start gap-1">
                  <i className="ri-mail-line text-2lg"></i>
                  <a href="mailto:info@Mandeep Mortgage.com" className="text-white/90 hover:text-white transition-colors tracking-wider ">
                
             info@mandeepmortgage.com
                  </a>
                </div>
                <div className="flex items-start ">
                 ...
                 Near GNDE college,  Ludhiana,Punjab
                  </span>
                </div>
...
>
  <i className="ri-instagram-line"></i>
          ...
          <h1 className="text-white font-medium tracking-widest text-center mt-4 lg:mt-[3rem]">
            Copyright © 2025 Mandeep Mortgage. All Rights Reserved.
          </h1>
        </main>
      </footer>
    </>
